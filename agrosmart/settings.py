...
# API Key para Google Cloud Vision / Gemini desde .env
GOOGLE_CLOUD_VISION_API_KEY = (
    os.getenv("GOOGLE_CLOUD_VISION_API_KEY")  # si la pones con este nombre
    or os.getenv("GOOGLE_API_KEY")            # o si solo usas GOOGLE_API_KEY
)

if not GOOGLE_CLOUD_VISION_API_KEY:
    raise RuntimeError(
        "Falta GOOGLE_CLOUD_VISION_API_KEY o GOOGLE_API_KEY en .env o en las variables de entorno."
    )
